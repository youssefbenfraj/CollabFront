...
@Component({
  selector: 'app-getmybuys',
  templateUrl: './getmybuys.component.html',
  styleUrl: './getmybuys.component.css'
})
export class GetmybuysComponent {
  document!: Document;
  files: string[] = [];
  constructor(
    private dialogRef: MatDialogRef<GetmybuysComponent>,
